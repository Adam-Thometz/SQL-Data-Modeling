...
(
  ...
  from_country_id INT NOT NULL REFERENCES countries (id),
  to_city_id INT NOT NULL REFERENCES cities (id),
  to_country_id INT NOT NULL REFERENCES countries (id)
);
...
INSERT INTO flights
  (departure, arrival, airline_id, from_city_id, from_country_id, to_city_id, to_country_id)
VALUES
